...
const FollowHandler_1 = __importDefault(require("./../components/Profil/FollowHandler"));
const UploadImg_1 = __importDefault(require("./../components/Profil/UploadImg"));
const Profil = () => {
